...
def lambda_handler(event, context):
    ...
    if str(userEmail) == "":                     # JSON response to email address being absent
        ...
        emailLogin = "ENTER_YOUR_EMAIL_ADDRESS_HERE"
        emailPassword = os.environ['EMAIL_PASSWORD']             # Variable needs to be declared in OS
        ...
        def send_email(subject, body, sender, receiver, emailPassword):
            ...
            msg['From'] = sender
            msg['To'] = receiver
            s = smtplib.SMTP_SSL('SMTP_SERVER_URL', 465)
